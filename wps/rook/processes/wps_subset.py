...
class Subset(Process):
    def __init__(self):
        inputs = [
            ...
            LiteralInput(
                ...
                "api key of the DDS",
                data_type="string",
                abstract="api key of the DDS for the authentication",
                min_occurs=1,
                max_occurs=1,
            ),
        ]
        ...
        super(Subset, self).__init__(
            ...
            identifier="subset",
            title="Subset",
            abstract="Run subsetting on climate model data. Calls geokube operators.",
            metadata=[
                Metadata("GEOKUBE", "https://github.com/opengeokube/geokube"),
            ],
            version="1.0",
            inputs=inputs,
            outputs=outputs,
    ...
    def _handler(self, request, response):
        ...
        inputs = {
            ...
            "api_key": parse_wps_input(request.inputs, "api_key", default=None),
        }
